...
const SignIn = () => {
   ...
   return ( 
      ...
      <div className="w-full h-[58px] flex items-center gap-[16px] px-[16px] bg-[#2E3558] rounded-[8px]">
               ...
               <Link to={'/'} className='w-full flex items-center justify-center h-[42px] bg-btnBg2 rounded-[8px] text-[#ffffff] font-[700] font-roboto transition-[500ms] hover:invert-[5%]'>SIGN IN</Link>
      </>
    );
}
